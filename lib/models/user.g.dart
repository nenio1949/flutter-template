...
const UserSchema = CollectionSchema(
  ...
  indexes: {},
  links: {
    r'department': LinkSchema(
      id: 721467260493963850,
      name: r'department',
      target: r'Department',
      single: true,
    ),
    ...
    r'creator': LinkSchema(
      id: 4898901294027701757,
      name: r'creator',
      target: r'User',
      single: true,
    ),
    r'modifier': LinkSchema(
      id: 4686710557575674293,
      name: r'modifier',
      target: r'User',
      single: true,
    )
...
User _userDeserialize(
  ...
  object.gender = _UsergenderValueEnumMap[reader.readByteOrNull(offsets[5])] ??
      GenderEnum.unknown;
  object.id = id;
...
List<IsarLinkBase<dynamic>> _userGetLinks(User object) {
  return [object.department, object.role, object.creator, object.modifier];
}

void _userAttach(IsarCollection<dynamic> col, Id id, User object) {
  object.id = id;
  object.department
      .attach(col, col.isar.collection<Department>(), r'department', id);
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  QueryBuilder<User, User, QAfterFilterCondition> accountEqualTo(
    String value, {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> accountGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> accountLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> accountBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<User, User, QAfterFilterCondition> accountStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> accountEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> accountContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> accountMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> accountIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'account',
        value: '',
  ...
  QueryBuilder<User, User, QAfterFilterCondition> accountIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'account',
        value: '',
...
extension UserQueryLinks on QueryBuilder<User, User, QFilterCondition> {
  QueryBuilder<User, User, QAfterFilterCondition> department(
    ...
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'department');
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> departmentIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'department', 0, true, 0, true);
    });
  }
  ...
  QueryBuilder<User, User, QAfterFilterCondition> creator(FilterQuery<User> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'creator');
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> creatorIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'creator', 0, true, 0, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> modifier(
      FilterQuery<User> q) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> modifierIsNull() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQuerySortBy on QueryBuilder<User, User, QSortBy> {
  QueryBuilder<User, User, QAfterSortBy> sortByAccount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'account', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByAccountDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQuerySortThenBy on QueryBuilder<User, User, QSortThenBy> {
  QueryBuilder<User, User, QAfterSortBy> thenByAccount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'account', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByAccountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'account', Sort.desc);
    });
  }
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  QueryBuilder<User, User, QDistinct> distinctByAccount(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, String, QQueryOperations> accountProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, GenderEnum, QQueryOperations> genderProperty() {
    return QueryBuilder.apply(this, (query) {
