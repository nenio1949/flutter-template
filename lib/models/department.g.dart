...
const DepartmentSchema = CollectionSchema(
  ...
  indexes: {},
  links: {
    r'parentDepartment': LinkSchema(
      id: -7388444144453316767,
      name: r'parentDepartment',
      target: r'Department',
      single: true,
    ),
    r'leader': LinkSchema(
      id: -6784647594018688237,
      name: r'leader',
      target: r'User',
      single: true,
    ),
    r'creator': LinkSchema(
      id: 6037559959970041846,
      name: r'creator',
      target: r'User',
      single: true,
    ),
    r'modifier': LinkSchema(
      id: -2522082378000343561,
      name: r'modifier',
      target: r'User',
      single: true,
    )
...
void _departmentAttach(IsarCollection<dynamic> col, Id id, Department object) {
  object.id = id;
  object.parentDepartment
      .attach(col, col.isar.collection<Department>(), r'parentDepartment', id);
  object.leader.attach(col, col.isar.collection<User>(), r'leader', id);
...
extension DepartmentQueryFilter
  ...
  QueryBuilder<Department, Department, QAfterFilterCondition> createdAtEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Department, Department, QAfterFilterCondition> createdAtLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Department, Department, QAfterFilterCondition> createdAtBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Department, Department, QAfterFilterCondition> deletedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'deleted',
  ...
  QueryBuilder<Department, Department, QAfterFilterCondition> updatedAtEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Department, Department, QAfterFilterCondition> updatedAtLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Department, Department, QAfterFilterCondition> updatedAtBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension DepartmentQueryLinks
    on QueryBuilder<Department, Department, QFilterCondition> {
  QueryBuilder<Department, Department, QAfterFilterCondition> parentDepartment(
      FilterQuery<Department> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'parentDepartment');
    });
  }

  QueryBuilder<Department, Department, QAfterFilterCondition>
      parentDepartmentIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'parentDepartment', 0, true, 0, true);
    });
  }

  QueryBuilder<Department, Department, QAfterFilterCondition> leader(
      FilterQuery<User> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'leader');
    });
  }

  QueryBuilder<Department, Department, QAfterFilterCondition> leaderIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'leader', 0, true, 0, true);
    });
  }

  QueryBuilder<Department, Department, QAfterFilterCondition> creator(
      FilterQuery<User> q) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Department, Department, QAfterFilterCondition> creatorIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'creator', 0, true, 0, true);
    });
  }

  QueryBuilder<Department, Department, QAfterFilterCondition> modifier(
      FilterQuery<User> q) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Department, Department, QAfterFilterCondition> modifierIsNull() {
    return QueryBuilder.apply(this, (query) {
...
extension DepartmentQuerySortBy
  ...
  QueryBuilder<Department, Department, QAfterSortBy> sortByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
    });
  }

  QueryBuilder<Department, Department, QAfterSortBy> sortByCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.desc);
    });
  }

  QueryBuilder<Department, Department, QAfterSortBy> sortByDeleted() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deleted', Sort.asc);
    });
  }

  QueryBuilder<Department, Department, QAfterSortBy> sortByDeletedDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Department, Department, QAfterSortBy> sortByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updatedAt', Sort.asc);
    });
  }

  QueryBuilder<Department, Department, QAfterSortBy> sortByUpdatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension DepartmentQuerySortThenBy
  ...
  QueryBuilder<Department, Department, QAfterSortBy> thenByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
    });
  }

  QueryBuilder<Department, Department, QAfterSortBy> thenByCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.desc);
    });
  }

  QueryBuilder<Department, Department, QAfterSortBy> thenByDeleted() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deleted', Sort.asc);
    });
  }

  QueryBuilder<Department, Department, QAfterSortBy> thenByDeletedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deleted', Sort.desc);
    });
  }
  ...
  QueryBuilder<Department, Department, QAfterSortBy> thenByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updatedAt', Sort.asc);
    });
  }

  QueryBuilder<Department, Department, QAfterSortBy> thenByUpdatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updatedAt', Sort.desc);
    });
  }
...
extension DepartmentQueryWhereDistinct
  ...
  QueryBuilder<Department, Department, QDistinct> distinctByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'createdAt');
    });
  }

  QueryBuilder<Department, Department, QDistinct> distinctByDeleted() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Department, Department, QDistinct> distinctByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension DepartmentQueryProperty
  ...
  QueryBuilder<Department, DateTime, QQueryOperations> createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'createdAt');
    });
  }

  QueryBuilder<Department, bool, QQueryOperations> deletedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Department, DateTime, QQueryOperations> updatedAtProperty() {
    return QueryBuilder.apply(this, (query) {
